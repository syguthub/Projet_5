...
@RunWith(AndroidJUnit4.class)
    public class ProjectDaoTest {
        ...
        private static Project PROJECT = Project.getProjectById(PROJECT_ID);
        ...
        public void create_All_Projects_And_Get_All_Project() throws InterruptedException{
            ...
            // TEST
            List<Project> projects = LiveDataTestUtil.getValue(this.database.projectDao().get_All_Projects());
            assertEquals(SIZE_PROJECT, projects.size());
        }
